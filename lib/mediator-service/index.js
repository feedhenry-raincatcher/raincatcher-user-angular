...
UserMediatorService.prototype.verifyUserSession = function verifyUserSession() {
  var promise = this.getErrorAndDoneTopicPromises(this.usersTopics, CONSTANTS.TOPICS.VERIFY_SESSION);

  this.mediator.publish(this.usersTopics.getTopic(CONSTANTS.TOPICS.VERIFY_SESSION));
